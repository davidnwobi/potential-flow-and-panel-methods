...
def compute_panel_quantities(panelized_geometry, V, AoA, x, y):
    V_normal, V_tangential, lam, gamma, u, v = run_panel_method(panelized_geometry=panelized_geometry, V=V, AoA=AoA,
                                                                x=x, y=y)
    ...
    return V_normal, V_tangential, sumLambda, sumGamma, panel_velocities, CL, cl_circulation


def test_naca0012_zero_degrees(naca0012_test_zero_degrees):
    panelized_geometry, V, AoA, x, y = naca0012_test_zero_degrees
    V_normal, V_tangential, sumLambda, sumGamma, panel_velocities, CL, cl_circulation = compute_panel_quantities(

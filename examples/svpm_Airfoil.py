...
x_foil_cl = 0
try:
    res = xf.find_pressure_coefficients(airfoil='naca' + airfoil, alpha=AoA, NACA=True, delete=True)
    x_foil_cl = xf.find_coefficients(airfoil='naca' + airfoil, alpha=AoA, NACA=True,  delete=True)['CL']
